...
class LexerSuite(unittest.TestCase):
    ...
    def test_stringlit(self):
        self.assertTrue(TestLexer.checkLexeme(""" "This is a string containing tab\t" ""","This is a string containing tab	,<EOF>",136))
    ...
    def test_comment_5(self):
        self.assertTrue(TestLexer.checkLexeme("## Pham v##an dat##","an,dat,Unterminated Comment",143))
    ...
    def test_comment_4(self):
        self.assertTrue(TestLexer.checkLexeme("## Pham #va#\\ dat##","<EOF>",301))